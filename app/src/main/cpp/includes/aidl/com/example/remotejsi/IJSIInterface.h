...
public:
  ...
  virtual ::ndk::ScopedAStatus handshake(const ::ndk::SpAIBinder& in_remoteJSIInterface, std::string* _aidl_return) = 0;
private:
...
public:
  ...
  ::ndk::ScopedAStatus handshake(const ::ndk::SpAIBinder& in_remoteJSIInterface, std::string* _aidl_return) override;
